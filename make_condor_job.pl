...
sub make_script {
  ...
  my @script_array = ();
  push @script_array, "#! /bin/csh";
  push @script_array, "# THIS IS AN AUTOMATICALLY GENERATED SCRIPT";
  push @script_array, "# MODIFY/RUN AT YOUR OWN RISK.";
  push @script_array, "# SCRIPT: $stub.csh";
  push @script_array, "";
  push @script_array, "# Get the proper environment:";
  push @script_array, "setenv HOME /phenix/u/\$LOGNAME";
  push @script_array, "source /etc/csh.login";
  push @script_array, "foreach i (/etc/profile.d/*.csh)";
  push @script_array, "source \$i";
  push @script_array, "end";
  push @script_array, "source /opt/phenix/bin/phenix_setup.csh";
  push @script_array, "source \$HOME/.cshrc";
  push @script_array, "echo \$MYINSTALL";
  push @script_array, "echo \$LD_LIBRARY_PATH";
  push @script_array, "";
